          ...
          <div class="col-lg-6 cwp23-text mt-lg-0 mt-5 pl-lg-5">
            <div class="cwp23-text-cols row">
              <div class="column col-6">
                <a href="#"><img src="{{asset('front/assets/images/b1.jpg')}}" alt="" class="radius-image img-fluid"></a>
              </div>
              <div class="column col-6">
                <a href="#"><img src="{{asset('front/images/b2.jpg')}}" alt="" class="radius-image img-fluid"></a>
              </div>
              <div class="column col-6 mt-4">
                <a href="#"><img src="{{asset('front/images/b3.jpg')}}" alt="" class="radius-image img-fluid"></a>
              </div>
              <div class="column col-6 mt-4">
                <a href="#"><img src="{{asset('front/images/b4.jpg')}}" alt="" class="radius-image img-fluid"></a>
              </div>
