...
<!-- Core CSS - Include with every page -->
    ...
    <div class="container">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Forgot Fassword</h3>
                    </div>
                    <div class="panel-body">
                        
        <form action="{{route('user.emailCheck')}}" role="form" method="post">
        @csrf
                            <fieldset>
       ...
       <button type="submit" name="forgot"class="btn btn-lg btn-success btn-block">Forgot Password</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
